...
Copyright
    ...
    build_step is distributed in the hope that it will be useful, but
...
project: str = 'build_step'
project_copyright: str = '2024, Vladimir Roncevic <elektron.ronca@gmail.com>'
author: str = 'Vladimir Roncevic <elektron.ronca@gmail.com>'
version: str = '2.0'
release: str = 'https://github.com/vroncevic/build_step/releases'
...
htmlhelp_basename: str = 'build_stepdoc'
latex_elements: Dict[Any, Any] = {}
latex_documents: List[Tuple[Any, ...]] = [(
    master_doc, 'build_step.tex', 'build_step Documentation',
    'Vladimir Roncevic \\textless{}elektron.ronca@gmail.com\\textgreater{}',
    'manual'
)]
man_pages: List[Tuple[Any, ...]] = [(
    master_doc, 'build_step', 'build_step Documentation', [author], 1
)]
texinfo_documents: List[Tuple[Any, ...]] = [(
    master_doc, 'build_step', 'build_step Documentation', author, 'build_step',
