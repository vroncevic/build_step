...
RUN mkdir -p /root/scripts/build_step/ver.4.0/
RUN mkdir /root/bin/
RUN cp -R /sh_tool/bin/   /root/scripts/build_step/ver.4.0/
RUN cp -R /sh_tool/conf/  /root/scripts/build_step/ver.4.0/
RUN cp -R /sh_tool/log/   /root/scripts/build_step/ver.4.0/
RUN rm -Rf /sh_tool/
RUN chmod -R 755 /root/scripts/build_step/ver.4.0/
RUN ln -s /root/scripts/build_step/ver.4.0/bin/build_step.sh /root/bin/build_step
RUN tree /root/scripts/build_step/ver.4.0/
